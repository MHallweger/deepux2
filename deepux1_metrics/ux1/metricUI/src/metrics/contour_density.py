...
def evaluate(contourDensity):
    if contourDensity >= 0.00 and contourDensity <= 0.12:
        evaluation = {'value': contourDensity, 'meaning': 'Good', 'evaluation': 'good'}
    elif contourDensity >= 0.13 and contourDensity <= 0.22:
        evaluation = {'value': contourDensity, 'meaning': 'Fair', 'evaluation': 'normal'}
    else:
        evaluation = {'value': contourDensity, 'meaning': 'Poor', 'evaluation': 'bad'}

...
def evaluate(luminanceSD):
    if luminanceSD >= 0.00 and luminanceSD <= 60.00:
        evaluation = {'value': luminanceSD, 'meaning': 'Good', 'evaluation': 'good'}
    elif luminanceSD >= 60.01 and luminanceSD <= 90.00:
        evaluation = {'value': luminanceSD, 'meaning': 'Acceptable', 'evaluation': 'normal'}
    else:
        evaluation = {'value': luminanceSD, 'meaning': 'Potential varied', 'evaluation': 'bad'}

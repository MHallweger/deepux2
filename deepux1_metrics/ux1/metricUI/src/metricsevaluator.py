...
class MetricsEvaluator:
    ...
    def getEvaluations(metricAsJsonObject):
        ...
        static_colour_clustersEvaluation = metrics_static_colour_clustering.evaluate(metricAsJsonObject['static_colour_clusters'])

        dynamic_colour_clustersEvaluation = metrics_dynamic_colour_clustering.evaluate(metricAsJsonObject['dynamic_colour_clusters'])
        ...
        metrics_contour_congestionEvaluation = metrics_contour_congestion.evaluate(metricAsJsonObject['contour_congestion'])

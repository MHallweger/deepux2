...
def evaluate(hsvUniqueValue: int):
    if hsvUniqueValue >= 0 and hsvUniqueValue <= 20000:
        evaluation = {'value': hsvUniqueValue, 'meaning': 'good', 'evaluation': 'good'}
    else:
        evaluation = {'value': hsvUniqueValue, 'meaning': 'potential varied', 'evaluation': 'normal'}

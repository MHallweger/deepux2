...
def evaluate(colourfulness):
    if colourfulness >= 0.00 and colourfulness <= 50.00:
        evaluation = {'value': colourfulness, 'meaning': 'Less colourful', 'evaluation': 'normal'}
    elif colourfulness >= 50.01 and colourfulness <= 100.00:
        evaluation = {'value': colourfulness, 'meaning': 'Fair', 'evaluation': 'normal'}
    else:
        evaluation = {'value': colourfulness, 'meaning': 'Colourful', 'evaluation': 'normal'}

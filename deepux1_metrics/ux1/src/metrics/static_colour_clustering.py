...
def evaluate(staticColourClusters):
    if staticColourClusters >= 0 and staticColourClusters <= 4000:
        evaluation = {'value': staticColourClusters, 'meaning': 'Less colourful', 'evaluation': 'normal'}
    elif staticColourClusters >= 4001 and staticColourClusters <= 8000:
        evaluation = {'value': staticColourClusters, 'meaning': 'Fair', 'evaluation': 'normal'}
    else:
        evaluation = {'value': staticColourClusters, 'meaning': 'Colourful', 'evaluation': 'normal'}

...
def build_generator(app_details_csv,models_dir,gui_information_dir,control_elements_id_dir,categories_app_emb,results_dir,results_pre_dir,cutted_ui_elements,cutted_resized_ui_elements):
    ...
    c_cat = ''
    for _cat in c_cats:        
        c_cat_emb_file = os.path.join(categories_app_emb, str(_cat)+'.txt')
    ...
    x_ids2 = [[x[0], x[4], cutted_ui_elements+'\\'+os.path.basename(os.path.dirname(x[4]))+'\\'+os.path.basename(x[4]).split('_')[0]+'\\'+
    ...
    for total_batch in range(TOTAL_BATCH):
        ...
        g_save_path = os.path.join(models_dir, c_cat)
        ...
        for p in range(4):
            ...
            for q in range(2):                        
                ...
                d_save_path = os.path.join(models_dir, c_cat)

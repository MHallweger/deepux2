...
def train_siamese(cutted_resized_ui_elements,data_dir,models_torch_dir):
    ...
    _train_pair_file = data_dir + '\\train_st_pair.txt'
    ...
    for e in range(epoch):
        ...
        torch.save(net.state_dict(), models_torch_dir + '/' + 'torch_siamese-' + str(e) + ".pkl")
        ...
        with open(models_torch_dir + '/' + 'train_loss', 'wb') as f:
            pickle.dump(train_loss, f)
    torch.save(net.state_dict(), models_torch_dir + '/' + 'torch_siamese.pkl')
